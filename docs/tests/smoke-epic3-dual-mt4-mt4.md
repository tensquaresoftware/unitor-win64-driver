...
| Sujet | Story |
|---|---|
| Chapitre multi-MT4 poli dans `docs/user/` | **4.2** / **6.2** — [Win11](../user/unitor-mt4-bridge-win11-wms-user-guide.md#use-two-mt4-interfaces) · [Win10](../user/unitor-mt4-bridge-win10-virtualmidi-user-guide.md#use-two-mt4-interfaces) ; smoke [`smoke-epic4-user-docs-mt4.md`](smoke-epic4-user-docs-mt4.md) |
...
- Guide utilisateur multi-MT4 : [Win11](../user/unitor-mt4-bridge-win11-wms-user-guide.md#use-two-mt4-interfaces) · [Win10](../user/unitor-mt4-bridge-win10-virtualmidi-user-guide.md#use-two-mt4-interfaces)
