...
- **SysEx librarian / burst** : checklist dédiée dans [`smoke-epic2-sysex-mt4.md`](smoke-epic2-sysex-mt4.md) (story 2.3).
...
- Smoke SysEx librarian / burst buffering (story 2.3) : suivre [`smoke-epic2-sysex-mt4.md`](smoke-epic2-sysex-mt4.md)
