...
- **Epic 2** (horloge, MTC, SysEx, Matrix-Control, longévité) : guide opérateur français [`smoke-epic2-mt4.md`](smoke-epic2-mt4.md) — ce guide Epic 1 reste notes/CC uniquement.
...
- Smoke Epic 2 (horloge, MTC, SysEx, Matrix-Control, ~4 h) : suivre [`smoke-epic2-mt4.md`](smoke-epic2-mt4.md)
