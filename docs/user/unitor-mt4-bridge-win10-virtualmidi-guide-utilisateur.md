...
Sur ce chemin, le Bridge parle au DAW via **virtualMIDI**. Installez-le depuis le site internet de Tobias Erichsen **avant** l’installateur du Bridge, en téléchargeant par exemple :
